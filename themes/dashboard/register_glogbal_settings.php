...
<ol class="breadcrumb pull-right">
	...
	<li class="#">User Register Settings</li>
	<li><a href="active">Global Settings</a></li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">User Register Settings / Global settings <small>Administration Control Panel</small></h1>
<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
                <!-- begin col-8 -->
			    <div class="col-md-8">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">User Register Settings/ Global Settings</h4>
                        </div>
