        ...
        switch($this->type)
        {
            case "header":
                $this->html .= '<div class="block-controls">
                                    <div class="block-controls-inner panel-heading-btn">
                                        ...
                                        <div class="dropdown block-add-child-block" style="z-index:10003;">
                                            <a rel="tooltip" data-placement="top" title="Add Section" class="btn btn-xs  btn-white dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown"> <i class="fa fa-th-large"></i>
                                            </a>
                ...
                $this->html .= '<div class="block-controls">
                                    <div class="block-controls-inner panel-heading-btn">
                                       ...
                                       <a rel="tooltip" data-placement="top" title="Minimize / Maximize" class="collapse-element btn btn-xs btn-warning"><i class="fa fa-minus"></i></a>
                                        ...
                                        <div class="dropdown block-add-child-block" style="z-index:10002;">
                                            <a rel="tooltip" data-placement="top" title="Add Section" class="btn btn-xs btn-white dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown"> <i class="fa fa-th-large"></i>
                                            </a>
            ...
            case "column":
                ...
                $this->html .= '<div class="block-controls">
                                    ...
                                    <div class="dropdown block-add-child-block" style="z-index:10001;">
                                        <a rel="tooltip" data-placement="top" title="Add Block" class="btn btn-xs  btn-white dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown"> <i class="fa fa-plus-square"></i>
                                        </a>
            ...
            case "content":
                ...
                $this->html .= '
                                        <a rel="tooltip" data-placement="top" title="Style Settings" class="style btn btn-xs  btn-white" data-click="" data-original-title="" title=""><i class="fa fa-paint-brush"></i></a>
                                        <div class="dropdown block-add-child-block" style="z-index:10000;">
                                            <a rel="tooltip" data-placement="top" title="Add Section" class="btn btn-xs btn-white dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown"> <i class="fa fa-th-large"></i>
                                            </a>
