							...
							<li class="masonry-item">
								<div class="item">
									<div class="item-title">
										<h2><a href="/blog/post/<?=$post->slug?>"> <?=stripslashes($post->title)?></a></h2>
                    ...
                    <?php if($this->BuilderEngine->get_option('be_blog_show_tags') != 'no'):?>
                        <div class="widget">
                            ...
                            <?php foreach($available_tags as $tag):?>
                                <a class="label label-default light" href="<?=base_url('blog/search/'.$tag)?>"><i class="fa fa-tags"></i> <?=stripslashes($tag)?></a>
                            <?php endforeach?>
                            <div class="clearfix"></div>
                        </div>
                    <?php endif;?>
