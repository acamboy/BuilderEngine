...
class ordered_list_block_handler extends  block_handler{
	...
	public function generate_content()
	{
		...
		return $output.$CI->layout_system->load_new_block_scripts($this->block->get_id(), 'ordered-list-'.$this->block->get_id(), $CI->BuilderEngine->get_page_path(), $single_element, $this->block->get_name(), 'advanced');
	}
}
?>